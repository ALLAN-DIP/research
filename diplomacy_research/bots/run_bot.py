...
from diplomacy_research.bots.dipnet_bot import DipnetAdvisor, DipnetPlayer

from chiron_utils.bots import BaselineBot
...
def main() -> None:
    ...
    parser.add_argument(
        "--bot_type",
        type=str,
        choices=["DipnetPlayer", "DipnetAdvisor", "DipnetMessageAdvisor"],
        default="player",
    ...
    bot_class: Type[BaselineBot] = DipnetPlayer 
    if bot_type=="DipnetPlayer":
        bot_class = DipnetPlayer
    elif bot_type=="DipnetAdvisor":
        bot_class = DipnetAdvisor
